  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 pb-20">
      <header>
        ...
        <p className="text-[11px] font-mono opacity-50 tracking-widest mt-1">Regional preferences, appearance, and backups</p>
      </header>
            ...
            <div className="rounded-3xl border border-slate-700/50 bg-slate-950/60 p-4">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-300">Switch between light and dark mode in the desktop app.</p>
                </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <Section title="Team Management" icon={<UserPlus className="w-5 h-5" />}>
          <div className="space-y-6">
            <form onSubmit={handleAddUser} className="space-y-4 bg-slate-950 border border-slate-700/80 p-4 rounded-[2rem]">
              ...
              <button
                type="submit"
                className="w-full bg-[#141414] text-white py-3 font-bold text-[10px] tracking-widest uppercase hover:invert transition-all"
              >
                Authorize User
              </button>
            </form>
        ...
        <Section title="Backup & Restore" icon={<HardDrive className="w-5 h-5" />}>
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-[#141414] text-[#E4E3E0] py-3 font-bold tracking-widest text-xs hover:invert transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {backupCreating ? (
            ...
            <div className="space-y-3 pt-2 border-t border-slate-700/80">
              <p className="text-[10px] font-bold uppercase tracking-widest opacity-40">Saved Backups</p>

              {backupsLoading ? (
                <p className="text-[10px] font-mono opacity-60">Loading backups…</p>
              ) : backups.length === 0 ? (
                <p className="text-[10px] font-mono opacity-60">No backups found yet.</p>
              ) : (
        ...
        <Section title="Submit Feedback" icon={<MessageSquare className="w-5 h-5" />}>
          <form onSubmit={handleFeedback} className="space-y-4">
            ...
            />
            <button type="submit" className="w-full bg-[#141414] text-[#E4E3E0] py-3 font-bold tracking-widest text-xs hover:invert transition-all">
...
function Input({ label, type = 'text', value, onChange = () => {} }: any) {
  return (
    <div className="flex flex-col gap-1.5">
      <label className="text-[10px] font-mono font-bold opacity-40 tracking-widest text-slate-300">{label}</label>
      <input
        type={type}
        value={value}
        onChange={e => onChange(e.target.value)}
